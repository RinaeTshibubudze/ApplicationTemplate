...
using SawsAppTemplate.Application.Features.ExtendedAttributes.Commands.Delete;
...
namespace SawsAppTemplate.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
