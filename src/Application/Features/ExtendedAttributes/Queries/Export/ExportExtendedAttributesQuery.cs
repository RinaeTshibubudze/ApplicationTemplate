...
using SawsAppTemplate.Application.Specifications.ExtendedAttribute;
using SawsAppTemplate.Domain.Contracts;
using SawsAppTemplate.Domain.Enums;
using SawsAppTemplate.Shared.Wrapper;
using MediatR;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Localization;

namespace SawsAppTemplate.Application.Features.ExtendedAttributes.Queries.Export
{
