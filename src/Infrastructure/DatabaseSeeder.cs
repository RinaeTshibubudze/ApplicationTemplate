...
using SawsAppTemplate.Infrastructure.Helpers;
using SawsAppTemplate.Infrastructure.Models.Identity;
using SawsAppTemplate.Shared.Constants.Permission;
using SawsAppTemplate.Shared.Constants.Role;
using SawsAppTemplate.Shared.Constants.User;
...
namespace SawsAppTemplate.Infrastructure
{
    public class DatabaseSeeder : IDatabaseSeeder
    {
        ...
        private void AddAdministrator()
        {
            Task.Run(async () =>
            {
                ...
                {
                    FirstName = "Rinae",
                    LastName = "Tshibubudze",
                    Email = "rinae.tshibubudze@weathersa.co.za",
                    UserName = "vharhee",
                    EmailConfirmed = true,
        ...
        private void AddBasicUser()
        {
            Task.Run(async () =>
            {
                ...
                var basicUser = new BlazorHeroUser
                {
                    FirstName = "John",
                    LastName = "Doe",
                    Email = "john.doe@weathersa.co.za",
                    UserName = "johndoe",
                    EmailConfirmed = true,
                    PhoneNumberConfirmed = true,
                    CreatedOn = DateTime.Now,
