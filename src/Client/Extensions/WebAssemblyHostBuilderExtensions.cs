...
using SawsAppTemplate.Client.Infrastructure.Authentication;
using SawsAppTemplate.Client.Infrastructure.Managers;
using SawsAppTemplate.Client.Infrastructure.Managers.Preferences;
...
using SawsAppTemplate.Client.Infrastructure.Managers.ExtendedAttribute;
using SawsAppTemplate.Domain.Entities.ExtendedAttributes;
using SawsAppTemplate.Domain.Entities.Misc;
using Toolbelt.Blazor.Extensions.DependencyInjection;

namespace SawsAppTemplate.Client.Extensions
{
